...
Audio assets live in a shared `modules/vesc-ble/sounds/` directory. A copy script places them into `android/src/main/res/raw/` (and later the iOS bundle). Format: OGG Vorbis, short clips (50–200ms for ticks, longer for voice/sustained).
